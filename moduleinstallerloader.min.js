...
function ModuleLoader(e){this.config=e}var Utils=require("./Utils"),Graph=require("./Graph");ModuleLoader.prototype.load=function(){function e(e,t){var r={};"object"==typeof e.modules&&null!=e.modules&&Utils.objectForEach(e.modules,function(e,t){r[t]=o.modulesLoaded[e]}),o.modulesLoaded[t]=require(e.require)(e.argument,r)}var o=Utils.parseArgs(arguments,[{name:"moduleKey",level:1,validate:function(e,o){return"string"==typeof e}},{name:"modulesConfig",level:0,validate:function(e,o){return"object"==typeof e}},{name:"modulesLoaded",level:1,validate:function(e,o){return"object"==typeof e&&null!=e},default:{}}]),t=this._dependencyGraph(o.modulesConfig);return"string"==typeof o.moduleKey?t.depthFirstTraverse(o.moduleKey,e):t.depthFirstTraverse(e),o.modulesLoaded},ModuleLoader.prototype._dependencyGraph=function(e){var o=Graph();return Utils.objectForEach(e,function(e,t){o.addNode(t,e)}),Utils.objectForEach(e,function(e,t){"object"==typeof e.modules&&null!=e.modules&&Utils.objectForEach(e.modules,function(e){o.addEdge(t,e)})}),o},module.exports=function(e){return new ModuleLoader(e)};
