...
function ModuleLoader(e){this.config=e}var Utils=require("./Utils"),Graph=require("./Graph");ModuleLoader.prototype.load=function(){function e(e,r){var t={};"object"==typeof e.required&&null!=e.required&&Utils.objectForEach(e.required,function(e,r){t[r]=o.modulesLoaded[e]});var n="function"==typeof e.function?e.function:require(e.require);o.modulesLoaded[r]=n(e.argument,t)}var o=Utils.parseArgs(arguments,[{name:"moduleKey",level:1,validate:function(e,o){return"string"==typeof e}},{name:"modulesConfig",level:0,validate:function(e,o){return"object"==typeof e}},{name:"modulesLoaded",level:1,validate:function(e,o){return"object"==typeof e&&null!=e},default:{}}]),r=this._dependencyGraph(o.modulesConfig);return"string"==typeof o.moduleKey?r.depthFirstTraverse(o.moduleKey,e):r.depthFirstTraverse(e),o.modulesLoaded},ModuleLoader.prototype._dependencyGraph=function(e){var o=Graph();return Utils.objectForEach(e,function(e,r){o.addNode(r,e)}),Utils.objectForEach(e,function(e,r){"object"==typeof e.required&&null!=e.required&&Utils.objectForEach(e.required,function(e){o.addEdge(r,e)})}),o},module.exports=function(e){return new ModuleLoader(e)};
},{"./Graph":1,"./Utils":4}],3:[function(require,module,exports){
function ModuleManager(e){this.moduleLoader=require("./ModuleLoader")(),this._modulesLoaded={}}var Utils=require("./Utils");ModuleManager.prototype.installModules=function(e,o){void 0===this.moduleInstaller&&(this.moduleInstaller=require("./ModuleInstaller")());var l=this.moduleInstaller,t=0,r={};Utils.objectForEach(e,function(e,n){void 0!==e.npm&&"string"!=typeof e.require&&(t++,l.installNpmModule(e.npm,function(l,u){t--,r[n]={error:l,install:u},l||(e.require=u.name),0==t&&o(r)}))}),0==t&&o(r)},ModuleManager.prototype.loadModules=function(e,o){var l=this;try{this.moduleLoader.load(e,l._modulesLoaded),o(null,l._modulesLoaded)}catch(e){o(e,l._modulesLoaded)}},ModuleManager.prototype.installLoadModules=function(e,o){var l=this;l.installModules(e,function(t){var r=!1;Utils.objectForEach(t,function(e){null!=e.error&&(r=!0)}),r?o(t,null):l.loadModules(e,o)})},module.exports=function(e){return new ModuleManager(e)};
